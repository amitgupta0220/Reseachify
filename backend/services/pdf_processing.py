...
# # Function to extract images in base64 format from CompositeElement objects
# def get_images_base64(chunks):
#     """
#     Extracts base64-encoded images from CompositeElement objects in PDF chunks.
...
#     """
#     Processes a PDF file to extract text, tables, and images.
...
#     Returns:
#         tuple: Extracted text chunks, tables, and base64-encoded images.

#     Raises:
#         RuntimeError: If an error occurs during PDF processing.
#     """
...
#                     # Ensure the table data is in a DataFrame-compatible format
...
#             json.dump([chunk.to_dict() for chunk in texts], f)

#         # Save images in base64 format to a JSON file
